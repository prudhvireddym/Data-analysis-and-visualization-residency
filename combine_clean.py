...
data_netflix = pd.read_csv('csvs/netflix_original_8810.csv')
data_imdb = pd.read_csv('csvs/netflix_imdb_9958.csv')
...
data_imdb.to_csv('csvs/data_imdb_Best_match_column.csv', index=False)
...
data_imdb.to_csv('csvs/merged_data.csv', index=False)



def clean_merged(merged_csv):
    # Load the merged data
    data_merged = pd.read_csv('csvs/merged_data.csv')
