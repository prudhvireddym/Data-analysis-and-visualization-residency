...
plt.title(f'Rating Distribution (Total: {len(data_cleaned)} rows)', fontsize=22)
...
plt.title(f'Top Genres (Total: {len(genres)} rows)', fontsize=22)
...
plt.title(f'Country-wise Content (Total: {len(data_cleaned)} rows)', fontsize=22)
plt.xlabel('Count', fontsize=18)
...
plt.title(f'Duration of Movies (Total: {len(movies)} rows)', fontsize=22)
...
plt.title(f'Duration of TV Shows (Seasons) (Total: {len(tv_shows)} rows)', fontsize=22)
...
plt.title(f'Content Type (Total: {len(data_cleaned)} rows)', fontsize=22)
